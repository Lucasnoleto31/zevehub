          ...
          <div className="text-center space-y-6">
            ...
            <div className="space-y-3 pt-4">
              ...
              <Button 
                ...
                onClick={() => window.open("https://wa.me/556299944855?text=Olá! Acabei de me cadastrar no Zeve Hub e gostaria de informações sobre a aprovação do meu acesso.", "_blank")}
              >
